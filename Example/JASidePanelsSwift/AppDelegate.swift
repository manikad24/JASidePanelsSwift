...
//  JASidePanelsSwift
//
//  Created by Manikandan on 11/17/2016.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        sideController?.centerPanel = storyBoard.instantiateViewController(withIdentifier: "Home1")
        sideController?.leftPanel = storyBoard.instantiateViewController(withIdentifier: "SideMenu")
